...
- Withdrawal tracks base text inserted by the daemon across HEAD changes, so narrowing sharing removes text keyed to earlier commits. Sharing and scope changes also invalidate in-flight publish and withdrawal reads before they can write stale results.
